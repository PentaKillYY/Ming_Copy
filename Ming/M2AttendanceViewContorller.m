//
//  M2AttendanceViewContorllerViewController.m
//  Ming2.0
//
...
#import "Constant.h"
@interface M2AttendanceViewContorller ()<UIWebViewDelegate,UIAlertViewDelegate>
...
@implementation M2AttendanceViewContorller

- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil{
    self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil];
    if (self) {
        // Custom initialization
        self.title = NSLocalizedString(@"异常考勤", @"");
    }
    return self;
}
...
- (void)viewDidLoad{
    ...
    _urlStirng=[NSString stringWithFormat:@"%@%@/Index/MIndex?employeeNo=%@&token=%@",AttendanceUrl,NSLocalizedString(@"lang", @""),[UserInfo sharedUserInfo].employeeNo,[UserInfo sharedUserInfo].token];

...
@interface M2LeaveViewController ()<UIWebViewDelegate,UIAlertViewDelegate>
...
@implementation M2LeaveViewController
...
- (void)viewDidLoad
{
    ...
    _urlStirng=[NSString stringWithFormat:@"%@%@/Index/MLeaveIndex?employeeNo=%@&token=%@",AskForLeaveUrl,NSLocalizedString(@"lang", @""),[UserInfo sharedUserInfo].account,[UserInfo sharedUserInfo].token];

...
- (UIView *)createContainerView
{
    ...
    UIView *dialogContainer = [[UIView alloc] initWithFrame:CGRectMake((screenSize.width - dialogSize.width-20) / 2, (screenSize.height - dialogSize.height-20) / 2, dialogSize.width+20, dialogSize.height+20)];

    // First, we style the dialog to match the iOS7 UIAlertView >>>
    CAGradientLayer *gradient = [CAGradientLayer layer];
    gradient.frame = dialogContainer.bounds;
    gradient.colors = [NSArray arrayWithObjects:
                       (id)[[UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1.0f] CGColor],
                       (id)[[UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1.0f] CGColor],
                       (id)[[UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1.0f] CGColor],
                       nil];

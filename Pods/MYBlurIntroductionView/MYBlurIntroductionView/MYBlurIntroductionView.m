...
//    [self addSubview:self.PageControl];
    ...
    if (self.frame.size.height > 480) {
        self.RightSkipButton.frame = CGRectMake(135, 435,160, 50);
    }else{
        self.RightSkipButton.frame = CGRectMake(135, 340,160, 50);
    }
    
//    [self.RightSkipButton.titleLabel setFont:kSkipButtonFont];
//    [self.RightSkipButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
